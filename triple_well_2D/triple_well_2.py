...
#%%
#states
initial_state = np.array([-5.7715972293490533928661534446291625499725341796875,  5.4694526174595439355376248779551373591090168702066875994205474853515625e-09])
saddle_state = np.array([0, -2.93429453258859905540045787120106979273259639739990234375e-02])
#saddle_state = np.array([0, 18])
target_state = np.array([5.7715972293490533928661534446291625499725341796875, 5.4694526174595439355376248779551373591090168702066875994205474853515625e-09])
...
#metastable minimum
y_intermediate = 20/1.5
depth_intermediate = 20/1.5
