...
#%%
#states
initial_state = np.array([-5.7717539205438415095272830512840300798416137695312500000000000000000000e+00, 3.3378635411302136460395198460642950284704699726034959894604980945587158e-11])
saddle_state = np.array([0, -2.93429453258859905540045787120106979273259639739990234375e-02])
#saddle_state = np.array([0, 18])
target_state = np.array([5.7717539205438415095272830512840300798416137695312500000000000000000000e+00, 3.3378635411302136460395198460642950284704699726034959894604980945587158e-11])
...
#metastable minimum
y_intermediate = 20/1.33
depth_intermediate = 20/1.33
